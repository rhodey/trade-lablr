...
public class PriceLabelProviderTest {
  ...
  public void test1() {
    ...
    LABELER.indexEvent(1, mockTake(25l,  13l));
  ...
  public void test2() {
    ...
    assert LABELER.labelFor(1).getValue() == 133l;
    assert LABELER.labelFor(2).getValue() == 1337l;
    assert LABELER.labelFor(3).getValue() == 1337l;
    assert LABELER.labelFor(4).getValue() == 31337l;
  }
